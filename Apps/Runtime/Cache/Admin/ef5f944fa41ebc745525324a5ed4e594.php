...
<form method="post" data-ajax action="<?php echo ($insertUrl); ?>">
    <div class=" col-md-4 col-sm-4 col-xs-4 col-lg-4">
                ...
                <input  value=""  name="account" type="text" placeholder="" id="field_account" class="form-control ">
                </div>
            </div>
    <div class=" col-md-4 col-sm-4 col-xs-4 col-lg-4">
                    <div class="form-group">
    ...
    <div class=" col-md-4 col-sm-4 col-xs-4 col-lg-4">
                ...
                <input  value=""  name="email" type="text" placeholder="" id="field_email" class="form-control ">
                </div>
            </div>
</form>